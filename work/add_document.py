...
def remove_ruby(
    ...
    filepath = "/workspace/work/doc/" + filename
    with open(filepath, "r", encoding="shift-jis") as input_file:
...
def setup_vectorDB(
    ...
    loader = TextLoader("/workspace/work/doc/" + filename)
...
if __name__ == "__main__":
    ...
    if not os.path.exists("/workspace/work/vector_DB"):
